...
import com.alexsav.baking_app.ui.fragments.RecipesFragment;
...
public class MainActivity extends AppCompatActivity implements RecipesFragment.OnRecipeClickListener {
    ...
    public void onRecipeSelected(Recipes recipes) {
        Intent intent = new Intent(this, RecipesInfoActivity.class);
        intent.putExtra(RecipesInfoActivity.RECIPE_KEY, recipes);
